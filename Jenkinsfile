...
def upstreamProjects = [
  ...
  '../oss/cron', // <groupId>com.aoapps</groupId><artifactId>ao-cron</artifactId>
  ...
  '../oss/net-types', // <groupId>com.aoapps</groupId><artifactId>ao-net-types</artifactId><classifier>sql</classifier>
  '../oss/payments/api', // <groupId>com.aoapps</groupId><artifactId>ao-payments-api</artifactId>
  '../oss/payments/api', // <groupId>com.aoapps</groupId><artifactId>ao-payments-api</artifactId><classifier>sql</classifier>
  '../oss/security', // <groupId>com.aoapps</groupId><artifactId>ao-security</artifactId>
  '../oss/security', // <groupId>com.aoapps</groupId><artifactId>ao-security</artifactId><classifier>sql</classifier>
  '../oss/sql', // <groupId>com.aoapps</groupId><artifactId>ao-sql</artifactId>
  '../oss/sql-pool', // <groupId>com.aoapps</groupId><artifactId>ao-sql-pool</artifactId>
  '../oss/tlds', // <groupId>com.aoapps</groupId><artifactId>ao-tlds</artifactId>
  '../oss/tlds', // <groupId>com.aoapps</groupId><artifactId>ao-tlds</artifactId><classifier>sql</classifier>
  ...
  'schema', // <groupId>com.aoindustries</groupId><artifactId>aoserv-schema</artifactId>
  // No Jenkins: <groupId>org.apache.commons</groupId><artifactId>commons-lang3</artifactId>

  // Runtime Direct
  '../oss/payments/all', // <groupId>com.aoapps</groupId><artifactId>ao-payments-all</artifactId>
