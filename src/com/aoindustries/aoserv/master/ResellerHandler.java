/*
 * Copyright 2009-2013, 2015, 2018 by AO Industries, Inc.,
...
final public class ResellerHandler {
     ...
     */
    public static Account.Name getResellerForBusinessAutoEscalate(
        ...
        while(account!=null) {
            ...
            account = BusinessHandler.getParentBusiness(conn, account);
        }
