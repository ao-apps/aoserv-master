...
final public class MySQLHandler {
    ...
    public static int addMySQLDatabase(
        ...
        String invalidReason = MySQLDatabaseTable.isValidDatabaseName(name, reservedWords);
    ...
    public static void setMySQLServerUserPassword(
        ...
        try {
            ...
            if(password!=MySQLUser.NO_PASSWORD) {
                List<PasswordChecker.Result> results = MySQLUser.checkPassword(MySQLUserId.valueOf(username), password);
