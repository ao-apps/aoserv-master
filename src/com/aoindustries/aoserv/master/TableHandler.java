			...
			case BUSINESS_SERVERS :
				if(masterUser != null) {
					...
					if(masterServers.length == 0) MasterServer.writeObjects(
						...
						provideProgress,
						new BusinessServer(),
						"select * from server.\"AccountServer\""
					); else MasterServer.writeObjects(
						conn,
						source,
						out,
			...
			case MASTER_SERVERS :
				if(masterUser != null) {
					...
					if(masterServers.length == 0) MasterServer.writeObjects(
						...
						"select * from server.\"MasterServer\""
					); else MasterServer.writeObjects(
						conn,
						source,
						out,
