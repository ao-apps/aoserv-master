 ...
 */
public class SpamAssassinMode_GetTableHandler implements TableHandler.GetTableHandlerPublic {

	@Override
	public Set<Table.TableID> getTableIds() {
		return EnumSet.of(Table.TableID.EMAIL_SPAMASSASSIN_INTEGRATION_MODES);
	}
