                                ...
                                try {
                                    ...
                                    switch(taskCode) {
                                        ...
                                        case ADD_MASTER_ENTROPY :
                                            ...
                                            break;
                                        case BACKUP_INTERBASE_DATABASE :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                        ...
                                        case FIND_FILE_BACKUPS_BY_MD5 :
                                            ...
                                            break;
                                        case FIND_LATEST_FILE_BACKUP_SET_ATTRIBUTE_MATCHES :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                        ...
                                        case FIND_OR_ADD_BACKUP_DATAS :
                                            ...
                                            break;
                                        case FLAG_BACKUP_DATA_AS_STORED :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                            ...
                                            break;
                                        case FLAG_FILE_BACKUPS_AS_DELETED :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                        ...
                                        case GENERATE_ACCOUNTING_CODE :
                                            ...
                                            break;
                                        case GENERATE_INTERBASE_DATABASE_NAME :
                                            {
                                                int dbGroup=in.readCompressedInt();
                                            ...
                                            break;
                                        case GENERATE_INTERBASE_DB_GROUP_NAME :
                                            {
                                                int aoServer=in.readCompressedInt();
                                                String template_base=in.readUTF().trim();
                                                String template_added=in.readUTF().trim();
                                        ...
                                        case GET_BACKUP_DATA :
                                            ...
                                            break;
                                        case GET_BACKUP_DATAS_FOR_BACKUP_PARTITION :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                        ...
                                        case GET_FILE_BACKUP_CHILDREN :
                                            ...
                                            break;
                                        case GET_FILE_BACKUP_SET_SERVER :
                                            {
                                                process.setPriority(Thread.NORM_PRIORITY-1);
                                                currentThread.setPriority(Thread.NORM_PRIORITY-1);
                                        ...
                                        case GET_FILE_BACKUP_VERSIONS :
                                            ...
                                            break;
                                        case GET_FILENAME_FOR_BACKUP_DATA :
                                            {
                                                int pkey=in.readCompressedInt();
                                                process.setCommand(
                                        ...
                                        case GET_INBOX_ATTRIBUTES :
                                            ...
                                            break;
                                        case GET_LATEST_FILE_BACKUP_SET :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                        ...
                                        case IS_EMAIL_DOMAIN_AVAILABLE :
                                            ...
                                            break;
                                        case IS_INTERBASE_DATABASE_NAME_AVAILABLE :
                                            {
                                                int dbGroup=in.readCompressedInt();
                                                String name=in.readUTF().trim();
                                                process.setCommand(
                                            ...
                                            break;
                                        case IS_INTERBASE_DB_GROUP_NAME_AVAILABLE :
                                            {
                                                int aoServer=in.readCompressedInt();
                                                String name=in.readUTF().trim();
                                                process.setCommand(
                                            ...
                                            break;
                                        case IS_INTERBASE_SERVER_USER_PASSWORD_SET :
                                            {
                                                int pkey=in.readCompressedInt();
                                                process.setCommand(
                                        ...
                                        case REMOVE_EXPIRED_FILE_BACKUPS :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                            ...
                                            break;
                                        case REMOVE_EXPIRED_INTERBASE_BACKUPS :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                            ...
                                            break;
                                        case REMOVE_EXPIRED_MYSQL_BACKUPS :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                            ...
                                            break;
                                        case REMOVE_EXPIRED_POSTGRES_BACKUPS :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                            ...
                                            break;
                                        case REMOVE_UNUSED_BACKUP_DATAS :
                                            {
                                        ...
                                        case REQUEST_DAEMON_ACCESS :
                                            ...
                                            break;
                                        case REQUEST_SEND_BACKUP_DATA_TO_DAEMON :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                        ...
                                        case SET_IMAP_FOLDER_SUBSCRIBED :
                                            ...
                                            break;
                                        case SET_INTERBASE_SERVER_USER_PASSWORD :
                                            {
                                                int pkey=in.readCompressedInt();
                                            ...
                                            break;
                                        case SET_INTERBASE_SERVER_USER_PREDISABLE_PASSWORD :
                                            {
                                                int pkey=in.readCompressedInt();
                                                String password=in.readBoolean()?in.readUTF():null;
                                                process.setCommand(
                                        ...
                                        case SET_LAST_DISTRO_TIME :
                                            ...
                                            break;
                                        case SET_LAST_FAILOVER_REPLICATION_TIME :
                                            {
                                                process.setPriority(Thread.MIN_PRIORITY+1);
                                                currentThread.setPriority(Thread.MIN_PRIORITY+1);
                                        ...
                                        case SET_CREDIT_CARD_USE_MONTHLY :
                                         ...
                                         case UPDATE_CREDIT_CARD :
                                            ...
                                            break;
                                        case UPDATE_CREDIT_CARD_CARD_INFO :
                                            {
                                                int pkey=in.readCompressedInt();
                                                String cardInfo=in.readUTF().trim();
                                                process.setCommand(
                                                ...
                                                CreditCardHandler.updateCreditCardCardInfo(
                                                    conn,
                                                    source,
                                                    invalidateList,
                                                    pkey,
