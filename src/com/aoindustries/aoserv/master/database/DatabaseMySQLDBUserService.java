...
final class DatabaseMySQLDBUserService extends DatabaseAccountTypeService<Integer,MySQLDBUser> implements MySQLDBUserService {
    ...
    @Override
    protected List<MySQLDBUser> getListMaster(DatabaseConnection db) throws SQLException {
    ...
    @Override
    protected List<MySQLDBUser> getListDaemon(DatabaseConnection db) throws SQLException {
        return db.executeObjectCollectionQuery(
            new ArrayList<MySQLDBUser>(),
            objectFactory,
            "select\n"
    ...
    @Override
    protected List<MySQLDBUser> getListBusiness(DatabaseConnection db) throws SQLException {
        return db.executeObjectCollectionQuery(
            new ArrayList<MySQLDBUser>(),
            objectFactory,
            "select\n"
