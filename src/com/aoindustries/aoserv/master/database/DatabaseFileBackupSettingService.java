...
final class DatabaseFileBackupSettingService extends DatabaseAccountTypeService<Integer,FileBackupSetting> implements FileBackupSettingService {
    ...
    @Override
    protected List<FileBackupSetting> getListMaster(DatabaseConnection db) throws SQLException {
    ...
    @Override
    protected List<FileBackupSetting> getListDaemon(DatabaseConnection db) throws SQLException {
        return db.executeObjectCollectionQuery(
            new ArrayList<FileBackupSetting>(),
            objectFactory,
            "select\n"
    ...
    @Override
    protected List<FileBackupSetting> getListBusiness(DatabaseConnection db) throws SQLException {
        return db.executeObjectCollectionQuery(
            new ArrayList<FileBackupSetting>(),
            objectFactory,
            "select\n"
