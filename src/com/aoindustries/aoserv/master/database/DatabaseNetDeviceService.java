...
final class DatabaseNetDeviceService extends DatabaseServiceIntegerKey<NetDevice> implements NetDeviceService<DatabaseConnector,DatabaseConnectorFactory> {
    ...
    protected Set<NetDevice> getSetMaster() throws IOException, SQLException {
    ...
    protected Set<NetDevice> getSetDaemon() throws IOException, SQLException {
        return connector.factory.database.executeObjectSetQuery(
            objectFactory,
            "select distinct\n"
            + "  nd.*\n"
    ...
    protected Set<NetDevice> getSetBusiness() throws IOException, SQLException {
        return connector.factory.database.executeObjectSetQuery(
            objectFactory,
            "select distinct\n"
            + "  nd.*\n"
