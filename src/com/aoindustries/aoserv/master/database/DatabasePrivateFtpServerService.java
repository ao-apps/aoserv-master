...
final class DatabasePrivateFtpServerService extends DatabaseService<Integer,PrivateFtpServer> implements PrivateFtpServerService<DatabaseConnector,DatabaseConnectorFactory> {
    ...
    protected Set<PrivateFtpServer> getSetMaster(DatabaseConnection db) throws IOException, SQLException {
    ...
    protected Set<PrivateFtpServer> getSetDaemon(DatabaseConnection db) throws IOException, SQLException {
        return db.executeObjectSetQuery(
            objectFactory,
            "select\n"
    ...
    protected Set<PrivateFtpServer> getSetBusiness(DatabaseConnection db) throws IOException, SQLException {
        return db.executeObjectSetQuery(
            objectFactory,
            "select\n"
            + "  pfs.ao_server_resource,\n"
