...
final class DatabaseDnsRecordService extends DatabaseService<Integer,DnsRecord> implements DnsRecordService<DatabaseConnector,DatabaseConnectorFactory> {
    ...
    protected Set<DnsRecord> getSetMaster(DatabaseConnection db) throws IOException, SQLException {
    ...
    protected Set<DnsRecord> getSetDaemon(DatabaseConnection db) throws IOException, SQLException {
    ...
    protected Set<DnsRecord> getSetBusiness(DatabaseConnection db) throws IOException, SQLException {
        return db.executeObjectSetQuery(
            objectFactory,
            "select\n"
            + "  dr.resource,\n"
