 ...
 */
final class DatabaseTicketTypeService extends DatabaseService<String,TicketType> implements TicketTypeService {
    ...
    @Override
    protected ArrayList<TicketType> getList(DatabaseConnection db) throws SQLException {
