      ...
      try {
        ...
        try (UnprotectedPassword password = (chars.length == 0) ? null : new UnprotectedPassword(chars)) {
          ...
          switch (protocolVersion) {
            case VERSION_1_92_2_4_SNAPSHOT:
            case VERSION_1_92_2_3_SNAPSHOT:
            case VERSION_1_92_2_2_SNAPSHOT:
            case VERSION_1_92_2_1_SNAPSHOT:
            case VERSION_1_92_2_SNAPSHOT:
            case VERSION_1_92_1:
            case VERSION_1_92_0:
            case VERSION_1_86_0:
