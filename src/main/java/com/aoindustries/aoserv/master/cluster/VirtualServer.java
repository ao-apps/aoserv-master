 ...
 * Copyright (C) 2007-2013, 2020, 2021, 2022, 2026  AO Industries, Inc.
...
public final class VirtualServer implements Comparable<VirtualServer> {
  ...
  public int realCompareTo(VirtualServer other) {
    ...
    if (primaryServerHostname != null) {
      if (other.primaryServerHostname == null) {
        return -1;
      }
    ...
    if (secondaryServerHostname != null) {
      if (other.secondaryServerHostname == null) {
        return -1;
      }
    ...
    // By RAM
    if (primaryRam < other.primaryRam) {
      return 1;
    }
    if (primaryRam > other.primaryRam) {
      return -1;
    }
    if (secondaryRam < other.secondaryRam) {
      return 1;
    }
    if (secondaryRam > other.secondaryRam) {
      return -1;
    ...
    if (minimumProcessorType != other.minimumProcessorType) {
      return false;
    }
    if (requiredProcessorArchitecture != other.requiredProcessorArchitecture) {
      return false;
    }
    if (minimumProcessorSpeed != other.minimumProcessorSpeed) {
      return false;
    }
    if (processorCores != other.processorCores) {
      return false;
    }
    if (processorWeight != other.processorWeight) {
      return false;
    }
    if (virtualDisks.length != other.virtualDisks.length) {
      return false;
    }
    for (int c=0;c<virtualDisks.length;c++) {
      if (!virtualDisks[c].equals(other.virtualDisks[c])) {
        return false;
      }
    }
     */
  ...
  public boolean equals(VirtualServer other) {
    ...
    if (!Strings.equals(primaryServerHostname, other.primaryServerHostname)) {
      return false;
    }
    if (!Strings.equals(secondaryServerHostname, other.secondaryServerHostname)) {
      return false;
    }
    for (int c=0;c<virtualDisks.length;c++) {
      if (!virtualDisks[c].equals(other.virtualDisks[c])) {
