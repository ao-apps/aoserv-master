    ...
    static {
      try {
        try {
          ...
          addSystemUser(ROCKY_9_SYSTEM_USERS,  User.TSS,                              59, Group.TSS,                  "Account used for TPM access",                                     "/",                             Shell.USR_SBIN_NOLOGIN, null);
          ...
          addSystemUser(ROCKY_9_SYSTEM_USERS,  User.SSHD,                             74, Group.SSHD,                 "Privilege-separated SSH",                                         "/usr/share/empty.sshd",         Shell.USR_SBIN_NOLOGIN,  null);
          ...
          addSystemUser(ROCKY_9_SYSTEM_USERS,  User.CHRONY,               ANY_SYSTEM_UID, Group.CHRONY,               "chrony system user",                                              "/var/lib/chrony",               Shell.NOLOGIN,  null);
          ...
          addSystemUser(ROCKY_9_SYSTEM_USERS,  User.PIPEWIRE,             ANY_SYSTEM_UID, Group.PIPEWIRE,             "PipeWire System Daemon",                                          "/run/pipewire",                 Shell.NOLOGIN,  null);
